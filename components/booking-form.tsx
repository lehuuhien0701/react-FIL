      ...
      <div className="flex items-center gap-3 text-[14px] text-[#88938F]">
        <div className="flex items-center gap-2">
          <input
            id="emailOptIn2"
            type="checkbox"
            className="w-4 h-4 rounded border border-navy/60 peer1 peer2 hidden"
