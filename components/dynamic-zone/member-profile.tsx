       ...
       <div className="w-full bg-[#fff] pt-16 pb-10 flex flex-col items-center relative bg-[url('/bg-line2.svg')] bg-top bg-repeat-y">
            ...
            <div className="flex flex-wrap items-center justify-center font-medium gap-4 text-[#0A2540] text-[20px] mb-5">
                ...
                <span className="flex items-center gap-2 ">
                  ...
                  <path d="M3.34315 14.6569C4.27976 15.5935 6.23844 17.5521 7.5862 18.8999C8.36725 19.681 9.63232 19.6814 10.4134 18.9003C11.7377 17.576 13.6584 15.6553 14.6569 14.6569C17.781 11.5327 17.781 6.46734 14.6569 3.34315C11.5327 0.218952 6.46734 0.218952 3.34315 3.34315C0.218952 6.46734 0.218953 11.5327 3.34315 14.6569Z" stroke="#0A2540" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M6 9C6 10.6569 7.34315 12 9 12C10.6569 12 12 10.6569 12 9C12 7.34315 10.6569 6 9 6C7.34315 6 6 7.34315 6 9Z" stroke="#0A2540" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                  {address}
                </span>
                )}
                ...
                <path d="M19 4L11.1094 9.2604C10.4376 9.70827 9.5624 9.70827 8.8906 9.2604L1 4M17 15L3 15C1.89543 15 1 14.1046 1 13L1 3C1 1.89543 1.89543 1 3 1L17 1C18.1046 1 19 1.89543 19 3L19 13C19 14.1046 18.1046 15 17 15Z" stroke="#0A2540" stroke-width="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
