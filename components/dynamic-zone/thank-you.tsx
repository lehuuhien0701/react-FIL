...
export const ThankYouPage = ({
  ...
  return (
    <>
        <div className='pb-14 py-20 md:py-[100px] min-h-[900px] relative bg-[linear-gradient(180deg,_#0a2540_0%,_#19191D_100%)]'>
            <div className='max-w-[1400px] mx-auto w-full px-5 md:px-10 lg:px-20'>
                <div className='max-w-[840px] m-auto relative z-[9999]'>
                    <div className='box-question text-center'>
                            <h1 className="italic-normal font-medium text-[70px] leading-[70px] text-white mb-6">{title || "Thank you !"}</h1>
                            ...
                            <a href="/" className="inline-block leading-[44px] w-full sm:w-auto text-sm font-medium text-secondary bg-white h-11 px-10 hover:bg-white transition duration-200">{button_text || "Back to home"}</a>
                    </div>
                </div>
                <div className=''>
                <div 
